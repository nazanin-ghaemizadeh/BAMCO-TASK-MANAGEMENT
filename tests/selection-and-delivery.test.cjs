...
test('performance report separates task-definition requests for self from requests for others',async t=>{
 ...
 f.tables.tasks.push({id:20,title:'مدیر',owner_id:'test-manager',created_by:'test-manager',created_at:from+'T08:00:00Z',source:'web',status:'در حال انجام',archived:false,due_date:from},{id:21,title:'متولی',owner_id:'test-owner',created_by:'test-owner',created_at:from+'T09:00:00Z',source:'web',status:'در حال انجام',archived:false,due_date:from},{id:22,title:'واگذاری مدیر',owner_id:'test-owner',created_by:'test-manager',created_at:from+'T10:00:00Z',source:'web',status:'در حال انجام',archived:false,due_date:from});
