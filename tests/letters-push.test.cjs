...
test('independent letters tab is available to explicitly granted owners; missing files cannot be downloaded and edits carry revision',async()=>{
 ...
 w.rpc=async()=>true;w.state={token:'test',profile:{role:'owner'}};w.SB_URL='https://example.test';w.SB_KEY='test';w.toast=()=>{};w.selectAll=async()=>[{id:'letter-1',letter_number:'1405/01',letter_date:'1405/01/01',recipient:'گیرنده',subject:'موضوع',version:4,storage_path:null}];
