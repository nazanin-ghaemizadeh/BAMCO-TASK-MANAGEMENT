...
(() => {
  ...
  function install() {
    ...
    q('#messageCenterAccess').onclick = () => window.bamcoAccessEditor?.open?.({ featureKey: feature(), title: 'مدیریت دسترسی ارسال پیام' });
