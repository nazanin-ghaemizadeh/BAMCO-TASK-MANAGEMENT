...
const views={userGuide:'documents',documents:'documents',letters:'letters',sitesAccess:'sitesAccess',kanban:'kanban',archive:'archive',taskTimeline:'calendar',approvals:'check',requestHistory:'history',approvalChains:'chain',people:'people',loginActivity:'login',activeSessions:'screen',messages:'messages',messageCenter:'send',sentMessages:'check',responseTracking:'reply',templates:'text',stickers:'sticker',vehiclePermanent:'vehicle',vehicleTemporary:'temporary',dashboard:'dashboard',performanceReport:'reports',messageReport:'messages',responseReport:'reply',requestReport:'tasks',loginReport:'login',systemOptions:'configuration',alertSettings:'bell',emailSettings:'messages',settings:'user',groupChat:'people',directMessages:'messages',taskChats:'conversations'};
