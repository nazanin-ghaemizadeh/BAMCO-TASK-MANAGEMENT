...
const paths={
 ...
 peopleDirectory:'M4 4h16v16H4zM9 11a2 2 0 1 0 0-4 2 2 0 0 0 0 4ZM5.5 17c.2-2.5 1.5-4 3.5-4s3.3 1.5 3.5 4M15 8h3M15 12h3M15 16h3',
 accessMatrix:'M4 4h16v16H4zM4 10h16M10 4v16M13 7l1.5 1.5L18 5M13 14l1.5 1.5L18 12',
 messages:'M3 5h18v14H3zM3 6l9 7 9-7',
 inbox:'M3 4h18v16H3zM3 13h5l2 3h4l2-3h5M7 8h10',
 conversations:'M21 4H3v13h5v4l5-4h8zM7 9h10M7 13h6',
 groupChat:'M3 4h18v14H8l-5 3V4ZM8 9a1 1 0 1 0 0 .01M12 9a1 1 0 1 0 0 .01M16 9a1 1 0 1 0 0 .01M7 14h10',
 directMessages:'M3 4h15v12H8l-5 4V4ZM18 8h3v12h-6l-3 2v-6M7 9h7M7 13h4',
 taskChats:'M3 4h18v14H8l-5 3V4ZM7 10l3 3 6-6M14 14h4',
 vehicle:'M4 10l2-6h12l2 6M3 10h18v8H3zM6 18v3M18 18v3M6 14h2M16 14h2',
 vehiclePermanent:'M3 11l2-5h14l2 5v7H3v-7ZM7 18v3M17 18v3M6 14h2M16 14h2M9 6l3-3 3 3',
 organization:'M12 3v4M5 11V7h14v4M12 7v4M5 11a2 2 0 1 0 0 4 2 2 0 0 0 0-4ZM12 11a2 2 0 1 0 0 4 2 2 0 0 0 0-4ZM19 11a2 2 0 1 0 0 4 2 2 0 0 0 0-4ZM2 20c0-2 1-3 3-3s3 1 3 3M9 20c0-2 1-3 3-3s3 1 3 3M16 20c0-2 1-3 3-3s3 1 3 3',
 reports:'M4 3v18h17M8 17v-5M13 17V7M18 17v-9',
 performance:'M4 18a8 8 0 1 1 16 0M12 14l4-5M8 18h8',
 configuration:'M4 7h6M14 7h6M4 17h10M18 17h2M10 4v6M14 14v6',
 options:'M4 5h16M4 12h16M4 19h16M8 3v4M16 10v4M10 17v4',
 ...
 responseChart:'M4 20V4M4 20h16M8 16l4-4 3 2 5-7M17 7h3v3',
 ...
 mailSettings:'M3 5h18v14H3zM3 6l9 7 9-7M17 14v4M15 16h4',
...
const views={userGuide:'guide',documents:'documents',letters:'letters',lettersIncoming:'letterIncoming',lettersOutgoing:'letterOutgoing',sitesAccess:'sitesAccess',projects:'projects',parts:'parts',invoices:'invoices',pettyCash:'cash',organization:'organization',tools:'tools',kanban:'kanban',archive:'archive',taskTimeline:'calendar',approvals:'check',requestHistory:'history',people:'peopleDirectory',accessMatrix:'accessMatrix',loginActivity:'login',activeSessions:'screen',messages:'inbox',messageCenter:'send',sentMessages:'sentLog',responseTracking:'reply',templates:'text',stickers:'sticker',vehiclePermanent:'vehiclePermanent',vehicleTemporary:'temporary',dashboard:'dashboard',performanceReport:'performance',messageReport:'messages',responseReport:'responseChart',requestReport:'tasks',loginReport:'login',systemOptions:'options',alertSettings:'bell',emailSettings:'mailSettings',settings:'user',groupChat:'groupChat',directMessages:'directMessages',taskChats:'taskChats',notes:'notes',voiceAssistant:'voiceAssistant'};
...
function install(){
 ...
 function refresh(){
  ...
  nav.querySelectorAll('[data-view]').forEach(button=>{
   const key=views[button.dataset.view];if(!paths[key])return;let icon=button.querySelector(':scope>b');if(!icon){icon=document.createElement('b');button.prepend(icon)}
