...
const ORDER={tasks:['kanban','archive','taskTimeline','approvals','requestHistory'],delivery:['projects','parts','invoices'],organization:['organization'],messages:['messageCenter','sentMessages','responseTracking','stickers'],people:['people','loginActivity','activeSessions'],conversations:['groupChat','directMessages','taskChats'],vehicle:['vehiclePermanent','vehicleTemporary'],reports:['dashboard','performanceReport','responseReport','pettyCash'],configuration:['systemOptions','settings','alertSettings','emailSettings']};
