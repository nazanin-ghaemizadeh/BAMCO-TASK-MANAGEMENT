...
function install(){
 ...
 function homeBroken(){
  // A delayed home mutation must never win over a route that navigation has
  // already made active. This protects editable module pages from an old
  // home-repair frame or observer callback.
  if(!homeExpected||dialog.open||app.classList.contains('hidden')||(typeof state!=='undefined'&&state.view!=='home'))return false;
