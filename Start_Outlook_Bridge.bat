...
:refresh
echo Downloading %~1 ...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command "$ProgressPreference='SilentlyContinue'; try { Invoke-WebRequest -UseBasicParsing '%BASEURL%/%~1?v=20260905-7' -OutFile '%~2'; exit 0 } catch { Write-Host $_.Exception.Message; exit 1 }"
